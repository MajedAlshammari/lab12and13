...
def queues_index():
	...
	curl -s -X GET -H 'Accept: application /json' http://localhost:5000/queues | python -mjson.tool
 	curl -s -X GET -H 'Accept: application /json' http://104.214.27.224:8080/queues | python -mjson.tool
	"""
	all = []
	conn = get_conn()
...
def queues_create():
	...
	curl -X POST -H 'Content-Type: application/json' http://localhost:5000/queues -d '{"name": "D12125199_Lab12"}'
	curl -X POST -H 'Content-Type: application/json' 104.214.27.224:8080/queues -d '{"name": "D12125199_Lab12"}'	
...
def queues_remove(name):
	...
	curl -X DELETE -H 'Accept: application/json' http://localhost:5000/queues/D12125199_Lab12
	curl -X DELETE -H 'Accept: application/json' 104.214.27.224:8080/queues/D12125199_Lab12
...
def messages_count(name):
	...
	curl -X GET -H 'Accept: application/json' http://localhost:5000/queues/D12125199_Lab12/msgs/count
	curl -X GET -H 'Accept: application/json' 104.214.27.224:8080/queues/D12125199_Lab12/msgs/count
	"""
...
def messages_write(name):
	...
	curl -s -X POST -H 'Accept: application/json' http://localhost:5000/queues/D12125199_Lab12/msgs -d '{"content": "this is the message I want to put on the queue"}' 
	curl -s -X POST -H 'Accept: application/json' 104.214.27.224:8080/queues/D12125199_Lab12/msgs -d '{"content": "this is the message I want to put on the queue"}'
	"""
...
def messages_read(name):
	...
	curl -X GET -H 'Accept: application/json' http://localhost:5000/queues/D12125199_Lab12/msgs
	curl -X GET -H 'Accept: application/json' 104.214.27.224:8080/queues/D12125199_Lab12/msgs
	"""
...
def messages_consume(name):
	...
	curl -X DELETE -H 'Accept: application/json' http://localhost:5000/queues/D12125199_Lab12/msgs
	curl -X DELETE -H 'Accept: application/json' 104.214.27.224:8080/queues/D12125199_Lab12/msgs
	"""
